import { Table, Dropdown, ListGroup, Form } from "react-bootstrap";
...
function App({ contents, onClicktoContent, categories, onOrderByClick, orderInfo, onChangeCategory }) {
    ...
    /* 사용자가 드롭 다운 버튼을 클릭했습니다. 상우 컴포넌트에게 정렬 방식을 알려주는 함수입니다. */
    ...
    const ChangedComboItem = (event) => {
        ...
        // change와 관련된 프롭스에게 해당 카테고리 정보(영문 이름)를 넘겨 줍니다.
        ...
        <>
                    ...
                    <tr>
                        ...
                        <td width="10%" valign="middle">
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    {/* id 속성으로 어떠한 항목이 클리되었는 지를 파악합니다. */}
            ...
            <div>
                <Form.Select name="category" onChange={ChangedComboItem}>
                    ...
                    {comboCategory} {/* 동적을오 생성된 콤보 아이템들 */}
                </Form.Select>
            </div>
