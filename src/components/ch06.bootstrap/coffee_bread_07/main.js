...
function App() {
    ...
    // 신규 상품을 추가해야 하므로 setProducts가 필요합니다.
    ...
    /* selectedId는 현재 선택이 된 항목의 상품 id 정보 입니다.
    프로그램 최초 시작 시 1번이  선택되었다고 가정합니다. */
    ...
    */
    ...
    const InsertCategory = (formData) => {
        ...
        // 파라미터 이름은 파일CreateCategory.js에서 참조해야 합니다.
